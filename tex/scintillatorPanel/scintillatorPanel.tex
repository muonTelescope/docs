...
\fig{./tex/scintillatorPanel/img/scintillatorPanel}{Fully assembled Scintilator panel.}{assembledPanel}
...
\fig{./tex/scintillatorPanel/img/scintillatorPaneExploded}{Exploded view shoing cotaings and fiber.}{explodedPanel}
